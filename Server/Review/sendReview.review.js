...
const getUserReview = asyncHandler(async (req, res) => {
  ...
  if ([full_name, email, subject, message].some((e) => !e || e.trim() === "")) {
  ...
  await sendMail(
    ...
    `Hi ${full_name}, we received your review and will get back to you soon.`,
    `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h2>Hi ${full_name}, thank you for reaching out! 🎉</h2>
