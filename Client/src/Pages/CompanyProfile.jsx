...
export default function CompanyProfile() {
  ...
  return (
    <>
      {/* Basic SEO */}
      <title>Company Profile | Talk2Hire Business Portal</title>

      <meta
        name="description"
        content="View and manage your company profile, branding, contact details, and core values inside the Talk2Hire employer dashboard."
      />

      {/* 🚨 Critical: prevent indexing */}
      <meta name="robots" content="noindex, nofollow, noarchive, nosnippet" />

      <link rel="canonical" href="https://talk2hire.com/company/profile" />

      {/* Open Graph (internal only) */}
      <meta property="og:title" content="Company Profile | Talk2Hire" />
      <meta
        property="og:description"
        content="Manage your company information and branding."
      />
      <meta property="og:type" content="website" />
      <meta property="og:url" content="https://talk2hire.com/company/profile" />
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                  ...
                  <div className="relative shrink-0">
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.88 }}
                      onClick={() =>
                        !isUploadingLogo && fileRef.current.click()
                      }
