...
const ErrorPage = ({ message, onBack }) => (
  <div
    ...
    style={{
      background:
        "linear-gradient(135deg, #fdf8f0 0%, #fef9ec 50%, #f5f0ff 100%)",
    ...
    <div className="w-full max-w-sm text-center ep-body">
      ...
      <div
        ...
        style={{
          ...
          boxShadow:
            "0 8px 32px -4px rgba(180,140,60,0.1), 0 20px 60px -12px rgba(99,102,241,0.08)",
        }}
      >
        <div
...
const CompanyMicrosoftCallback = () => {
  ...
  useEffect(() => {
    if (isAuthenticated) navigate("/company", { replace: true });
  }, [isAuthenticated]);
